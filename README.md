...
**Отказоустойчивость.** Старые посты и ручные значения объединяются со свежими данными без предварительной очистки листа; шапки самовосстанавливаются; неполный снимок аудитории не меняет историю; формулы учитывают локаль таблицы.
